...
public class InterfazEmpresaTransporte extends JFrame
{
    ...
    /**
     * Método para actualizar el precio total del consumo de gasolina por camión
     */
    public void agregar_Consumo_precio_gasolina(String Matricula) {
    	EmpresaTransporte emp = new EmpresaTransporte();
    	String matriculaC1 = emp.darCamion1().darMatricula() ;
    	String matriculaC2 = emp.darCamion2().darMatricula() ;
    	String matriculaC3 = emp.darCamion3().darMatricula() ;
    	String matriculaC4 = emp.darCamion4().darMatricula() ;
    	
		if (matriculaC1.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion1(),1);
		}else if (matriculaC2.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion2(),1);
		}else if (matriculaC3.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion3(),1);
		}else if (matriculaC4.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion4(),1);
		}
    }
    
    /**
     * Método para quitar el precio total del consumo de gasolina por camión
     */
    public void quitar_Consumo_precio_gasolina(String Matricula) {
    	EmpresaTransporte emp = new EmpresaTransporte();
    	String matriculaC1 = emp.darCamion1().darMatricula() ;
    	String matriculaC2 = emp.darCamion2().darMatricula() ;
    	String matriculaC3 = emp.darCamion3().darMatricula() ;
		...
		if (matriculaC1.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion1(),2);
		}else if (matriculaC2.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion2(),2);
		}else if (matriculaC3.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion3(),2);
		}else if (matriculaC4.equals(Matricula)) {
			panelInformación.actualizarInformacion_Consumo_precio(emp.darCamion4(),2);
		}
    }
        ...
        if( ingresado != null )
        {
            try
            {
                ...
                if( carga > 0 )
                {
                    ...
                    {
                        actualizar( );   
                        agregar_Consumo_precio_gasolina(pMatricula);
                    }
                    else
                    {
    ...
    public void descargar( String pMatricula )
    {
        ...
        actualizar( );
        quitar_Consumo_precio_gasolina(pMatricula);
    }
    ...
    {
        Double resultado = empresaTransporte.darConsumoTotal();
        if (resultado != 0.0) {
        	JOptionPane.showMessageDialog( this, "El costo total de gasolina es: $ "+resultado, "Respuesta", JOptionPane.INFORMATION_MESSAGE );	
		}
    }
