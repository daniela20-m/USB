...
import uniandes.cupi2.empresaTransporte.interfaz.InterfazEmpresaTransporte;
import uniandes.cupi2.empresaTransporte.interfaz.PanelInformacion;
...
public class EmpresaTransporte {
	...
	public int darCargaTotal() {
		return camion1.darCargaActual() + camion2.darCargaActual() + camion3.darCargaActual()
				+ camion4.darCargaActual();
	}
	...
	/**
	 * Retorna la cantidad de consumo total de gasolina de los camiones.
	 * 
	...
	public Double darConsumoTotal() {
		...
		double precio = 0;
		if (valor != null) {
			if (valor.equals(camion1.darMatricula())) {
				precio = camion1.darConsumo() * 9702;

			} else if (valor.equals(camion2.darMatricula())) {
				precio = camion2.darConsumo() * 9702;

			} else if (valor.equals(camion3.darMatricula())) {
				precio = camion3.darConsumo() * 9702;
